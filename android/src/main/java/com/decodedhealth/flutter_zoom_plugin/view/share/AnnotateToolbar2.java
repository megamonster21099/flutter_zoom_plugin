package com.decodedhealth.flutter_zoom_plugin.view.share;
...
import com.decodedhealth.flutter_zoom_plugin.AndroidAppUtil;
...
public class AnnotateToolbar2 extends FrameLayout implements IColorChangedListener, View.OnClickListener{
	...
	private final static String TAG = AnnotateToolbar2.class.getSimpleName();

	private InMeetingAnnotationController mAnnotationController;

	public AnnotateToolbar2(Context context) {
		super(context);
		init(context);
	}

	public AnnotateToolbar2(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public AnnotateToolbar2(Context context, AttributeSet attrs, int defStyle) {
	...
	private class GuestureListener extends ToolbarDragView.ToolbarScrollListener {
		...
		public boolean onScroll(MotionEvent e1, MotionEvent e2,
			...
			int width = AnnotateToolbar2.this.getWidth();
			int height = AnnotateToolbar2.this.getHeight();
			int top = AnnotateToolbar2.this.getTop() + dy;
			int left = AnnotateToolbar2.this.getLeft() + dx;
			...
			AnnotateToolbar2.this.layout(left, top, left+width, top+height);
			return true;
		}
	}
